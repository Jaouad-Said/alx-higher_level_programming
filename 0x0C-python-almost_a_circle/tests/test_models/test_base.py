...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_square_two_dicts(self):
        squ1 = Square(10, 2, 3, 4)
        squ2 = Square(4, 5, 21, 2)
        list_dicts = [squ1.to_dictionary(), squ2.to_dictionary()]
...
class TestBase_create(unittest.TestCase):
    ...
    def test_create_square_original(self):
        ...
        squ2 = Square.create(**squ1_dictionary)
        self.assertEqual("[Square] (7) 5/1 - 3", str(squ1))

    def test_create_square_new(self):
        squ1 = Square(3, 5, 1, 7)
        squ1_dictionary = squ1.to_dictionary()
        squ2 = Square.create(**squ1_dictionary)
        self.assertEqual("[Square] (7) 5/1 - 3", str(squ2))

    def test_create_square_is(self):
        squ1 = Square(3, 5, 1, 7)
        squ1_dictionary = squ1.to_dictionary()
        squ2 = Square.create(**squ1_dictionary)
        self.assertIsNot(squ1, squ2)
...
class TestBase_load_from_file(unittest.TestCase):
    ...
    def test_load_from_file_first_square(self):
        ...
        self.assertEqual(str(squ1), str(list_squares_output[0]))
    ...
    def test_load_from_file_second_square(self):
        ...
        Square.save_to_file([squ1, squ2])
        list_squares_output = Square.load_from_file()
        self.assertEqual(str(squ2), str(list_squares_output[1]))
